###########################################################################
## Makefile generated for Simulink model 'arm_cortex_a_profiling'. 
## 
## Makefile     : arm_cortex_a_profiling.mk
## Generated on : Sun Jan 21 09:39:54 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arm_cortex_a_profiling.elf
...
PRODUCT_NAME              = arm_cortex_a_profiling
MAKEFILE                  = arm_cortex_a_profiling.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = arm_cortex_a_profiling_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arm_cortex_a_profiling.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -IC:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/ne10library.instrset/Ne10-1.1.2/inc -IC:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/ne10library.instrset/Ne10-1.1.2/common -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a_crl/crl -I$(START_DIR)/arm_cortex_a_profiling_ert_rtw/instrumented -IC:/Sumpurn/Project/sEmbeddedCPU/models -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a/include -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a/blocks/sfcn/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=arm_cortex_a_profiling -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DARM_PROJECT -DMW_STANDALONE_EXECUTION_PROFILER_ON -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
DEFINES_BUILD_ARGS = -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0
DEFINES_IMPLIED = -DTID01EQ=0
DEFINES_SKIPFORSIL = -DARM_PROJECT -DSTACK_SIZE=64 -DRT
DEFINES_STANDARD = -DMODEL=arm_cortex_a_profiling -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/arm_cortex_a_profiling_ert_rtw/instrumented/arm_cortex_a_profiling.c $(START_DIR)/arm_cortex_a_profiling_ert_rtw/instrumented/arm_cortex_a_profiling_data.c $(START_DIR)/arm_cortex_a_profiling_ert_rtw/instrumented/rtGetInf.c $(START_DIR)/arm_cortex_a_profiling_ert_rtw/instrumented/rtGetNaN.c $(START_DIR)/arm_cortex_a_profiling_ert_rtw/instrumented/rt_nonfinite.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c profile_timer.c code_profiling_utility_functions.c

MAIN_SRC = $(START_DIR)/arm_cortex_a_profiling_ert_rtw/instrumented/ert_main.c
...
OBJS = rt_logging.c.o arm_cortex_a_profiling.c.o arm_cortex_a_profiling_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o linuxinitialize.c.o profile_timer.c.o code_profiling_utility_functions.c.o
...
%.c.o : $(START_DIR)/arm_cortex_a_profiling_ert_rtw/instrumented/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/arm_cortex_a_profiling_ert_rtw/instrumented/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.pp.o : $(START_DIR)/arm_cortex_a_profiling_ert_rtw/instrumented/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
