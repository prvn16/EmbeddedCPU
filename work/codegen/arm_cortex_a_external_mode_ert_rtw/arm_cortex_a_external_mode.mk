###########################################################################
## Makefile generated for Simulink model 'arm_cortex_a_external_mode'. 
## 
## Makefile     : arm_cortex_a_external_mode.mk
## Generated on : Sun Jan 21 08:09:22 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arm_cortex_a_external_mode.elf
...
PRODUCT_NAME              = arm_cortex_a_external_mode
MAKEFILE                  = arm_cortex_a_external_mode.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = arm_cortex_a_external_mode_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arm_cortex_a_external_mode.elf
...
DEFINES_STANDARD = -DMODEL=arm_cortex_a_external_mode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/arm_cortex_a_external_mode_ert_rtw/arm_cortex_a_external_mode.c $(START_DIR)/arm_cortex_a_external_mode_ert_rtw/arm_cortex_a_external_mode_data.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a/src/rtiostream_tcpip.c

MAIN_SRC = $(START_DIR)/arm_cortex_a_external_mode_ert_rtw/ert_main.c
...
OBJS = arm_cortex_a_external_mode.c.o arm_cortex_a_external_mode_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
%.c.o : $(START_DIR)/arm_cortex_a_external_mode_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/arm_cortex_a_external_mode_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.pp.o : $(START_DIR)/arm_cortex_a_external_mode_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
rtiostream_tcpip.c.o : C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a/src/rtiostream_tcpip.c
	$(CC) $(CFLAGS) -o $@ $<
