...
## Generated on : Sun Jan 21 07:41:52 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: ./arm_cortex_a_counter_rtwlib.lib
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = arm_cortex_a_counter_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
...
PRODUCT = ./arm_cortex_a_counter_rtwlib.lib
...
DEFINES_ = -DSLMSG_ALLOW_SYSTEM_ALLOC -DMODEL=arm_cortex_a_counter -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DARM_PROJECT -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
SRCS = $(START_DIR)/slprj/ert/arm_cortex_a_counter/arm_cortex_a_counter.c
...
%.c.o : $(START_DIR)/slprj/ert/arm_cortex_a_counter/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/slprj/ert/arm_cortex_a_counter/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.pp.o : $(START_DIR)/slprj/ert/arm_cortex_a_counter/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
