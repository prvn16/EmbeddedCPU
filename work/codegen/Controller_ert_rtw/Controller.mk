...
## Generated on : Sun Jan 21 06:58:00 2018
...
DEFINES_ = -DMODEL=Controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DARM_PROJECT -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
%.c.o : $(START_DIR)/Controller_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<
...
%.pp.o : $(START_DIR)/Controller_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
