...
## Generated on : Sun Jan 21 07:51:35 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arm_cortex_a_top_model_pil.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arm_cortex_a_top_model_pil.elf
...
DEFINES_ = -DMODEL=arm_cortex_a_top_model_pil -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DARM_PROJECT -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
SRCS = $(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/arm_cortex_a_top_model_pil.c profile_timer.c code_profiling_utility_functions.c
...
OBJS = arm_cortex_a_top_model_pil.c.o profile_timer.c.o code_profiling_utility_functions.c.o
...
%.c.o : $(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.pp.o : $(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
