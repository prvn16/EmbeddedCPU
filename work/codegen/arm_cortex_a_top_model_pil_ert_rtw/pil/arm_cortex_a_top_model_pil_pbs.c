/*
 * arm_cortex_a_top_model_pil_pbs.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: arm_cortex_a_top_model_pil
 * Component Simulink Path: arm_cortex_a_top_model_pil
 * Simulation Mode: PIL
 *
 */

#define S_FUNCTION_NAME                arm_cortex_a_top_model_pil_pbs
  ...
  memUnitSizeBytes)
{
  ...
  pCodeInstrServiceData->infoPath = "./arm_cortex_a_top_model_pil_ert_rtw/pil";
  ...
  pCodeInstrServiceData->inTheLoopType = 0;
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("arm_cortex_a_top_model_pil");
