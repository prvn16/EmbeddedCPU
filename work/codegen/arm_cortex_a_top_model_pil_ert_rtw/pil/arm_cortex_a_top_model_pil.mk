###########################################################################
## Makefile generated for Simulink model 'arm_cortex_a_top_model_pil'. 
## 
## Makefile     : arm_cortex_a_top_model_pil.mk
## Generated on : Sun Jan 21 07:52:04 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: arm_cortex_a_top_model_pil.elf
...
PRODUCT_NAME              = arm_cortex_a_top_model_pil
MAKEFILE                  = arm_cortex_a_top_model_pil.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = arm_cortex_a_top_model_pil_ref.rsp
...
PRODUCT = arm_cortex_a_top_model_pil.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -IC:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/ne10library.instrset/Ne10-1.1.2/inc -IC:/ProgramData/MATLAB/SupportPackages/R2017b/3P.instrset/ne10library.instrset/Ne10-1.1.2/common -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a_crl/crl -I$(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw -IC:/Sumpurn/Project/sEmbeddedCPU/models -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a/include -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a/blocks/sfcn/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/pil -I$(MATLAB_ROOT)/extern/include/coder/connectivity/XILTgtAppSvc -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CoderAssumpTgtAppSvc -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CodeInstrTgtAppSvc
...
DEFINES_ = -DMODEL=arm_cortex_a_top_model_pil -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DARM_PROJECT -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DCA_CHECK_LONG_LONG_ENABLED=0 -DCA_CHECK_FLOATING_POINT_ENABLED=1 -DCODER_ASSUMPTIONS_ENABLED=1 -DRTIOSTREAM_RX_BUFFER_BYTE_SIZE=128 -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=128 -DCODE_INSTRUMENTATION_ENABLED=1 -DMEM_UNIT_BYTES=1 -DMemUnit_T=uint8_T
...
DEFINES_STANDARD = -DMODEL=arm_cortex_a_top_model_pil -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_interface_lib.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_services.c $(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/pil/xil_interface.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xilcomms_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_app.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/pil/arm_cortex_a_top_model_pil_ca.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/pil_main.c C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a/src/rtiostream_tcpip.c $(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/pil/xil_instrumentation.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_rtiostream.c C:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a/src/profile_timer.c
...
PREBUILT_OBJS = ../instrumented/arm_cortex_a_top_model_pil.c.o
...
xil_interface.c.o : $(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/pil/xil_interface.c
	$(CC) $(CFLAGS) -o $@ $<


arm_cortex_a_top_model_pil_ca.c.o : $(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/pil/arm_cortex_a_top_model_pil_ca.c
	$(CC) $(CFLAGS) -o $@ $<


xil_instrumentation.c.o : $(START_DIR)/arm_cortex_a_top_model_pil_ert_rtw/pil/xil_instrumentation.c
	$(CC) $(CFLAGS) -o $@ $<
