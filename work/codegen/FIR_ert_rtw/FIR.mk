###########################################################################
## Makefile generated for Simulink model 'FIR'. 
## 
## Makefile     : FIR.mk
## Generated on : Sun Jan 21 04:31:44 2018
...
MODELREF_LINK_RSPFILE_NAME = FIR_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = FIR_ref.rsp
...
DEFINES_STANDARD = -DMODEL=FIR -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = NE10_fir.neon.s NE10_fir_init.obj NE10_mask_table.obj FIR.obj
...
{$(START_DIR)\FIR_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FIR_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
