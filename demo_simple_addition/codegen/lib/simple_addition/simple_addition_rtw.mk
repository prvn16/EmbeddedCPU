...
## Generated on : Sun Jan 21 10:16:38 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/simple_addition.lib
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/simple_addition.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/simple_addition -I$(START_DIR) -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a/include -IC:/ProgramData/MATLAB/SupportPackages/R2017b/toolbox/target/supportpackages/arm_cortex_a/blocks/sfcn/include -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DARM_PROJECT -DSTACK_SIZE=200000 -DMODEL=simple_addition -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/codegen/lib/simple_addition/simple_addition_initialize.c $(START_DIR)/codegen/lib/simple_addition/simple_addition_terminate.c $(START_DIR)/codegen/lib/simple_addition/simple_addition.c $(START_DIR)/codegen/lib/simple_addition/rt_nonfinite.c $(START_DIR)/codegen/lib/simple_addition/rtGetNaN.c $(START_DIR)/codegen/lib/simple_addition/rtGetInf.c
...
OBJS = simple_addition_initialize.c.o simple_addition_terminate.c.o simple_addition.c.o rt_nonfinite.c.o rtGetNaN.c.o rtGetInf.c.o
...
%.c.o : $(START_DIR)/codegen/lib/simple_addition/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/codegen/lib/simple_addition/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.pp.o : $(START_DIR)/codegen/lib/simple_addition/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
