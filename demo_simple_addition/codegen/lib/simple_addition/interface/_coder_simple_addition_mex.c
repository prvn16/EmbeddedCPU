 ...
 * File: _coder_simple_addition_mex.c
 *
...
static void simple_addition_mexFunction(int32_T nlhs, mxArray *plhs[1], int32_T
  ...
  nrhs, const mxArray *prhs[2])
{
  ...
  /* Call the function. */
  simple_addition_api(inputs, outputs);
...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs, const mxArray
                 *prhs[])
{
  mexAtExit(simple_addition_atexit);
  ...
  simple_addition_mexFunction(nlhs, plhs, nrhs, prhs);
}
...
/*
 * File trailer for _coder_simple_addition_mex.c
 *
 * [EOF]
 */
